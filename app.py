...
# ── Header ─────────────────────────────────────────────────────────────────────
st.markdown("""
<div style="text-align:center; padding:32px 0 16px 0; border-bottom:2px solid #334155;">
    <h1 style="color:#F1F5F9; font-size:3.2rem; font-weight:900; margin:0; letter-spacing:-0.02em;">
    ...
    <div style="font-size:0.9rem; color:#94A3B8; margin-top:8px; line-height:1.6;">
        ...
        <strong>Dataset:</strong> 25K transactions · 8K customers · 6-year period (Jan 2020 – Mar 2026)
    </div>
</div>
